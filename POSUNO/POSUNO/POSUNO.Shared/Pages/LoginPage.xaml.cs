...
namespace POSUNO.Pages
{
    ...
    public sealed partial class LoginPage : Page
    {
        ...
        private async Task<bool> ValidForm()
        {
            ...
            {
                messageDialog = new MessageDialog("Debes Ingresar Email", "Error");
                await messageDialog.ShowAsync();
                return false;
            }
            ...
            {
                messageDialog = new MessageDialog("Debes Ingresar Email Valido", "Error");
                await messageDialog.ShowAsync();
                return false;
            }
            ...
            {
                messageDialog = new MessageDialog("Debes Ingresar Contraseña", "Error");
                await messageDialog.ShowAsync();
                return false;
            }
